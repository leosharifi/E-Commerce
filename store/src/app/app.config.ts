...
export const appConfig: ApplicationConfig = {
  ...
  provideFirebaseApp(() => initializeApp({
    projectId: devEnvironment.firebaseConfig.projectId,
    appId: devEnvironment.firebaseConfig.appId,
    storageBucket: devEnvironment.firebaseConfig.storageBucket,
    apiKey: devEnvironment.firebaseConfig.apiKey,
    authDomain: devEnvironment.firebaseConfig.authDomain,
    messagingSenderId: devEnvironment.firebaseConfig.messagingSenderId,
    measurementId: devEnvironment.firebaseConfig.measurementId
  })),
